    ...
    <div className="bg-white rounded-lg shadow-md border border-gray-200 w-full max-w-3xl mx-auto">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
          ...
          <button
            onClick={handleShare}
            className="flex items-center gap-2 text-gray-600 hover:text-green-500 transition-colors p-2 rounded-lg hover:bg-green-50 ml-auto"
          >
        ...
        <ConfirmModal
          ...
          onConfirm={async () => {
            ...
            try {
              ...
              toast.error(
                err?.response?.data?.message || err.message || 'Lỗi khi xóa bài đăng'
              );
            } finally {
