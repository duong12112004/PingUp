        ...
        <div className='bg-white rounded-lg shadow p-6 '>
          ...
          <form action="" className='space-y-4 ' onSubmit={handleSaveProfile}>
            ...
            <div>
              ...
              <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter a short bio' onChange={(e) => setEditForm({ ...editForm, username: e.target.value })} value={editForm.bio} />
            </div>
            ...
            <div>
              ...
              <input type='text' className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your location' onChange={(e) => setEditForm({ ...editForm, username: e.target.value })} value={editForm.location} />
            </div>
